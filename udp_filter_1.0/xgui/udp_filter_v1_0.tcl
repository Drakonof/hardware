...
proc init_gui { IPINST } {
  ...
  set IP_PART_2 [ipgui::add_param $IPINST -name "IP_PART_2" -parent ${IP_address}]
  set_property tooltip {IP Part 2} ${IP_PART_2}
  set IP_PART_3 [ipgui::add_param $IPINST -name "IP_PART_3" -parent ${IP_address}]
  set_property tooltip {IP Part 4} ${IP_PART_3}
  set IP_PART_4 [ipgui::add_param $IPINST -name "IP_PART_4" -parent ${IP_address}]
  set_property tooltip {IP Part 3} ${IP_PART_4}
